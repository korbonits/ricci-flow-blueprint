...
\begin{lemma}[Curvature and Ricci are pointwise in the last slot]
  ...
  \lean{CovariantDerivative.curvature_congr_third, CovariantDerivative.ricci_congr_snd_of_eq, CovariantDerivative.ricciAt, CovariantDerivative.inner_curvature_eq_zero_of_dep, RicciFlowBlueprint.hasPositiveRicciLC_iff_tangent, RicciFlowBlueprint.hasConstSecLC_iff_mul}
  \leanok
