...
\begin{lemma}[Evolution of the curvature tensor]
  ...
  $\Rm$ --- and that rewriting is a matter of moving covariant derivatives past
  each other, for which Lemmas \ref{lem:bilin-ricci-identity} and
  \ref{lem:curvature-ricci-identity} are the ingredients.
\end{lemma}
