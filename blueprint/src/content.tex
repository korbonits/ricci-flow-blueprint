...
\begin{definition}[Parallel sections and geodesics]
  ...
  \textbf{What is still needed to \emph{solve} the equation} is the regularity
  of $\Gamma$ in $y$ --- which needs the connection itself to be $C^k$, a
  hypothesis nothing above uses --- after which
  $\nab_{\gamma'}\gamma' = 0$ is an ODE to which Picard--Lindel\"of applies.
\end{definition}
