...
\begin{theorem}[Hamilton--Ivey pinching]
  ...
  \emph{(Cao--Zhu, Theorem 2.4.1.)} What remains is $f^{-1}$ and its
  concavity, hence convexity of $K$; the assembly of
  Lemma~\ref{lem:ivey-boundary} into invariance of $K$; and, for Hamilton's
  later improvement with the $\log(1+t)$ term, a form of
