...
\begin{definition}[Milnor frame]
  ...
  \textbf{Existence is assumed, not proved.} Milnor's classification lemma ---
  that every unimodular $3$-dimensional metric Lie algebra admits such a frame
  --- is not formalized. The results below take the frame as a hypothesis.
\end{definition}
