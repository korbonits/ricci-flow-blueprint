...
\begin{definition}[Parallel sections and geodesics]
  ...
  \textbf{What is still needed to \emph{solve} the equation} is to make
  $\Gamma$ a function of the point with enough regularity, turning
  $\nab_{\gamma'}\gamma' = 0$ into $c'' = -\Gamma(c')(c')$, an ODE to which
  Picard--Lindel\"of applies.
\end{definition}
