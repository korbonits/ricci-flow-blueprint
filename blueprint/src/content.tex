...
\begin{lemma}[Differentiating the Koszul combination]
  ...
  So with $h = \partial_t \g$ the double trace above is
  $\operatorname{tr}_\g(\partial_t\Ric)$; under the Ricci flow $h = -2\Ric$
  and the two contracted Bianchi identities (Theorems
