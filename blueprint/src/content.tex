...
\begin{lemma}[Curvature and Ricci are pointwise in the last slot]
  ...
  \lean{CovariantDerivative.curvature_congr_third, CovariantDerivative.ricci_congr_snd_of_eq, CovariantDerivative.ricciAt, RicciFlowBlueprint.hasPositiveRicciLC_iff_tangent}
  \leanok
