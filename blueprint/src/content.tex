...
\begin{lemma}[$\nab \Rm$ is tensorial in its direction]
  ...
  \scal$, are about. The other three slots are not done: $Y$ and $Z$ should go
  the same way, and $W$ needs the frame-and-globalise argument of
  Lemma \ref{lem:curvature-pointwise} one level up.
\end{lemma}
